	...
	while true
		   do
			...
			if [ " $arpd " != " $carpd " ]; then
				...
				echo "gateway changed from" $arpd " to" $carpd " at time " $(date +"%T") " on " $(date +"%D") "The attacker's MAC vendor is " $macvendor
...
#==================================================================================================================================================
   ...
   while true
		do
			...
			while true 
			  do sudo airmon-ng -0 1000 -a $arpd -c $carpd $interface'mon' 
			done
			exit
